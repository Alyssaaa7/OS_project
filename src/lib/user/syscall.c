...
int num_buffer_hit(void) { return syscall0(SYS_HIT); }

int num_buffer_access(void) { return syscall0(SYS_BUFACC); }

unsigned long long disk_write_cnt(void) { return syscall0(SYS_DWCNT); }
